...
$(document).ready(function() {
    ...
    $("#download").click(function() {
        ...
        var Html = `<div id='myDiv'>
          <p style="font-size: 50px; width: 100%; text-align: center;">LOGO MART</p>
          LOGO MART 
          <p style="font-size: 50px; width: 100%; text-align: center; margin-top: 30px;">LOGO MART</p>
          </div>`;
        $("#mainCanvas").append(Html);
        $("#myDiv").css({
